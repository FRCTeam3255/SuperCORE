...
public class SN_SuperSwerve extends SubsystemBase {
   ...
   * @param CANBusName
   *                                  The name of the CANBus that the Pigeon is
   *                                  on.
   * @param pigeonCANId
   ...
   * @param driveConfig
   *                                  The configuration for each drive motor. Make
   *                                  sure you set the
   *                                  inversion, neutral mode, and sensor to
   *                                  mechanism ratio!
   * @param steerConfig
   *                                  The configuration for each steer motor. Make
   *                                  sure you set the
   *                                  inversion, neutral mode, sensor to mechanism
   *                                  ratio, and continuous
   *                                  wrap!
   * @param cancoderConfig
   *                                  The configuration for each CANCoder. Make
   *                                  sure you set the sensor
   *                                  direction!
   * @param stateStdDevs
   ...
   *                                  The PID controller used to control
   *                                  rotational snapping and auto
   *                                  driving during Teleoperated.
   * @param turnSpeed
   *                                  The turning speed of the robot.
   * @param autoFlipPaths
   *                                  Determines if paths should be flipped to the
   *                                  other side of the
   *                                  field. This will maintain a global blue
   *                                  alliance origin. Used for
   *                                  PathPlanner
   * @param isSimulation
   ...
   *                         locking X or Y axes.
   * @param isOpenLoop
   *                         Whether the drive system should operate in open-loop
   *                         mode.
   * @param lockX
   *                         If true, the X-axis velocity will be locked to the
   *                         manual
   *                         velocity.
   * @param lockY
   *                         If true, the Y-axis velocity will be locked to the
   *                         manual
   *                         velocity.
  ...
  /**
   * @param desiredTarget    The target pose (position and orientation) to align
   *                         to.
   * @param manualVelocities The manually controlled velocities to be applied,
   *                         used
   *                         when locking X or Y axes.
   * @param isOpenLoop       Whether the drive system should operate in open-loop
   *                         mode.
   * @param lockX            If true, the X-axis velocity will be locked to the
   *                         manual
   *                         velocity.
   * @param lockY            If true, the Y-axis velocity will be locked to the
   *                         manual
   *                         velocity.
