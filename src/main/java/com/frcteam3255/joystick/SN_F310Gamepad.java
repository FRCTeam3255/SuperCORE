...
public class SN_F310Gamepad extends Joystick {
	...
	/** Joystick Button 7 */
	public Button btn_Back = new JoystickButton(this, 7);
	/** Joystick Button 8 */
	public Button btn_Start = new JoystickButton(this, 8);
	/** Joystick Button 9 */
	public Button btn_LStick = new JoystickButton(this, 9);
	/** Joystick Button 10 */
	public Button btn_RStick = new JoystickButton(this, 10);
