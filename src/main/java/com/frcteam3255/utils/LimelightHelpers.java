...
public class LimelightHelpers {
	...
	public static class RawFiducial {
		...
		public boolean equals(Object obj) {
			...
			return id == other.id && Double.compare(txnc, other.txnc) == 0 && Double.compare(tync, other.tync) == 0
					&& Double.compare(ta, other.ta) == 0 && Double.compare(distToCamera, other.distToCamera) == 0
	...
	public static class PoseEstimate {
		...
		public boolean equals(Object obj) {
			...
			return Double.compare(that.latency, latency) == 0 && tagCount == that.tagCount
					&& Double.compare(that.tagSpan, tagSpan) == 0 && Double.compare(that.avgTagDist, avgTagDist) == 0
	 ...
	 * in normalized screen space (-1 to 1).
	 *
	 * @param limelightName
	 *            Name/identifier of the Limelight
	 ...
	 * "send contours" to be enabled in the Limelight Output tab.
	 *
	 * @param limelightName
	 *            Name/identifier of the Limelight
	 ...
	 *
	 * @param pose
	 *            The PoseEstimate object to print. If null, prints "No PoseEstimate
	 *            available."
	 */
	 ...
	 *            Name of the Limelight camera
	 * @param horizontal
	 *            Horizontal keystone value (-0.95 to 0.95)
	 * @param vertical
	 *            Vertical keystone value (-0.95 to 0.95)
	 */
	 ...
	 * @param yawRate
	 *            (Unnecessary) Angular velocity of robot yaw in degrees per second
	 * @param pitch
	 *            (Unnecessary) Robot pitch in degrees
	 * @param pitchRate
	 *            (Unnecessary) Angular velocity of robot pitch in degrees per
	 *            second
	 * @param roll
	 *            (Unnecessary) Robot roll in degrees
	 * @param rollRate
	 ...
	 *            Name/identifier of the Limelight
	 * @param alpha
	 *            Defaults to .001. Higher values will cause the internal IMU to
	 ...
	 *            Name/identifier of the Limelight
	 * @param downscale
	 *            Downscale factor. Valid values: 1.0 (no downscale), 1.5, 2.0, 3.0,
	 ...
	 *            Name of the Limelight camera
	 * @param enabled
	 *            True to enable recording, false to pause
	 */
	 ...
	 * 165 seconds. Rate-limited on the Limelight.
	 *
	 * @param limelightName
	 *            Name of the Limelight camera
	 * @param durationSeconds
	 *            Duration of rewind capture in seconds (max 165)
	 */
	 ...
	 * access to the Limelight web interface and video stream when connected to the
	 * robot over USB.
	 *
	 * For usbIndex 0: ports 5800-5809 forward to 172.29.0.1 For usbIndex 1: ports
	 * 5810-5819 forward to 172.29.1.1 etc.
	 *
	 * Call this method once during robot initialization. To access the interface of
	 * the camera with usbIndex0, you would go to roboRIO-(teamnum)-FRC.local:5801.
	 * Port 5811 for usb index 1
	 *
	 * @param usbIndex
	 *            The USB index of the Limelight (0, 1, 2, etc.)
	 */
