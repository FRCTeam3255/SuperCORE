...
public class SN_Math {
	...
	// start code taken from 364's BaseFalconSwerve
	...
	/**
     * @param velocityCounts Falcon Integrated Encoder Counts per 100 ms
     ...
     * @param gearRatio Gear Ratio between Falcon and Mechanism (set to 1 for Falcon RPM)
     * @return Falcon Integrated Encoder Counts per 100 ms
     */
	...
	// end code taken from 364's BaseFalconSwerve 
}
